...
class Filter extends Item{
	...
	protected static $_comparisonTypesAssoc = array(
		\ComparisonType::Equal => '=',
		\ComparisonType::Greater => '>',
		\ComparisonType::GreaterOrEqual => '>=',
		\ComparisonType::Less => '<',
		\ComparisonType::LessOrEqual => '<=',
		\ComparisonType::NotEqual => array('<>', '!')
	);
	
	private static $paramsAssoc = array(
		'from' => 'valueFrom',
		'to' => 'valueTo',
	...
	public static function isScalarValue($value) {
		if (is_array($value)) {
			foreach (array('value', 'valueFrom', 'from', 'valueTo', 'to') as $k) {
