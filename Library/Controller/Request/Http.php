<?php
require_once 'Library/Controller/Request/Abstract.php';

require_once 'Library/Uri.php';

class Controller_Request_Http extends Controller_Request_Abstract{
    ...
    public function __construct($uri = null) {
        if (null !== $uri) {
            ...
            if ($uri->valid()) {
                ...
                require_once 'Library/Controller/Request/Exception.php';
                throw new Controller_Request_Exception('Invalid URI provided to constructor');
            }
        } else {
            $this->setRequestUri();
        }
	...
	public function isXmlHttpFormRequest() {
		return ($this->getParam('XMLHttpFormRequest') == 1);
	}
