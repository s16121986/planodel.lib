 ...
 *
 * @uses       Controller_Plugin_Abstract
 * @category   Zend
 * @package    Controller
 * @subpackage Plugins
 * @copyright  Copyright (c) 2005-2011 Zend Technologies USA Inc. (http://www.zend.com)
 ...
 */
class Controller_Plugin_ErrorHandler extends Controller_Plugin_Abstract
{
    /**
     ...
     *
     * @param  array $options
     * @return Controller_Plugin_ErrorHandler
     */
    ...
    public function getErrorHandlerModule()
    {
        if (null === $this->_errorModule) {
            $this->_errorModule = $this->_request->getModuleName();//Controller_Front::getInstance()->getDispatcher()->getDefaultModule();
        }
     ...
     * @return void
     */
    protected function _handleError(Controller_Request_Abstract $request)
    {
        $frontController = Controller_Front::getInstance();
        ...
        if (($response->isException()) && (!$this->_isInsideErrorHandlerLoop)) {
            ...
            switch ($exceptionType) {
                case 'Controller_Router_Exception':
                    ...
                    break;
                case 'Controller_Dispatcher_Exception':
                    $error->type = self::EXCEPTION_NO_CONTROLLER;
                    break;
                case 'Controller_Action_Exception':
                    if (404 == $exception->getCode()) {
