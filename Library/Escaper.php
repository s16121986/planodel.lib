...
abstract class Escaper {
	 ...
	 * @var string
	 */
	protected static $htmlSpecialCharsFlags = ENT_QUOTES;
	 ...
	 * @var callable
	 */
	protected static $htmlAttrMatcher;
	 ...
	 * @var array
	 */
	protected static $supportedEncodings = array(
	...
	public static function escapeHtml($string) {
		$result = htmlspecialchars($string, self::$htmlSpecialCharsFlags, self::$encoding);
		return $result;
	}
	...
	public static function escapeHtmlAttr($string) {
		...
		$result = preg_replace_callback('/[^a-z0-9,\.\-_]/iSu', self::$htmlAttrMatcher, $string);
		return self::fromUtf8($result);
	}
	...
	public static function escapeJs($string) {
		...
		$result = preg_replace_callback('/[^a-z0-9,\._]/iSu', self::$jsMatcher, $string);
		return self::fromUtf8($result);
	}
	...
	public static function escapeCss($string) {
		...
		$result = preg_replace_callback('/[^a-z0-9]/iSu', self::cssMatcher, $string);
		return self::fromUtf8($result);
	}
	 ...
	 * @return string
	 */
	protected static function toUtf8($string) {
		if (self::getEncoding() === 'utf-8') {
			$result = $string;
		} else {
			$result = self::convertEncoding($string, 'UTF-8', self::getEncoding());
		}

		if (!self::isUtf8($result)) {
	 ...
	 * @return string
	 */
	protected static function fromUtf8($string) {
		if (self::getEncoding() === 'utf-8') {
			return $string;
		}

		return self::convertEncoding($string, self::getEncoding(), 'UTF-8');
	}
	 ...
	 * @return string
	 */
	protected static function convertEncoding($string, $to, $from) {
		$result = '';
