...
abstract class Format{
	...
	public static function formatDate($date, $format = null) {
		return Dater::format($date, self::getDefault($format, self::DATE_FORMAT));
	}

	public static function formatTime($time, $format = Dater::TIME_FORMAT) {
		return Dater::format($time, self::getDefault($format, self::TIME_FORMAT));
	}

	public static function formatDatePeriod($dateFrom, $dateTo, $format = 'j F Y') {
		$now = Dater::initDatetimeObject(time());
		$dateFrom = Dater::initDatetimeObject($dateFrom);
		$dateTo = Dater::initDatetimeObject($dateTo);
		...
		return Dater::format($dateFrom, $format) . ' - ' . Dater::format($dateTo, $toFormat);
	}
